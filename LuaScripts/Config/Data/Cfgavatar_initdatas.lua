...
function Cfgavatar_initdatas.GetByKey(key)
	if Cfgavatar_initdatas[key] == nil then
		LogError('Cfgavatar_initdatas 配置没有key对应:',key)
	end
	return Cfgavatar_initdatas[key]
end
